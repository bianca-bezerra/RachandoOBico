...
func _ready():
	...
	queue_text("Senhor: Miragem não...é apenas um milho falso para despistar os ladrões do verdadeiro caminho da minha plantação")
	queue_text("Frito: Entendo...T-T")
	queue_text("Senhor: Você parece tão fraquinho, desmaiado por aqui...")
	queue_text("Senhor: Vou lhe ajudar a se recuperar, meu milharal fica ali no Outro Lado!")
